...
public class JournalAdapter {
    ...
    public void recordJournalEntries(Set<org.jboss.examples.bankplus.reporting.model.JournalEntry> journalEntries) {
    ...
    public List<org.jboss.examples.bankplus.reporting.model.JournalEntry> getEntriesForMonth(String accountId) {
        ...
        Client client = ClientBuilder.newClient();
        WebTarget target = client.target("http://localhost:9080/bankplus/rest/").path("journal").queryParam("accountId", accountId).queryParam("start", monthStart);
    ...
    public List<org.jboss.examples.bankplus.reporting.model.JournalEntry> getEntriesForYear(String accountId) {
        ...
        Client client = ClientBuilder.newClient();
        WebTarget target = client.target("http://localhost:9080/bankplus/rest/").path("journal").queryParam("accountId", accountId).queryParam("start", yearStart);
    ...
    public List<org.jboss.examples.bankplus.reporting.model.JournalEntry> getEntries(String accountId, LocalDate from, LocalDate to) {
        ...
        Client client = ClientBuilder.newClient();
        WebTarget target = client.target("http://localhost:9080/bankplus/rest/").path("journal").queryParam("accountId", accountId).queryParam("start", rangeStart).queryParam("end", rangeEnd);
